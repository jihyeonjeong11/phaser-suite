...
import { STATIC_TILE_PROPERTIES, TEMP_OBJECT_TILES } from "../../game/utils/constants/tiles";
...
export class MapObject {
  // this should hold all tile properties, states else
          ...
          if (t.properties.Diggable && !this.isTileOccupied(t.x, t.y)) {
            ...
            if (roll > 0.9) {
             initialMap[this.posToString(t.x, t.y)] =  TEMP_OBJECT_TILES.tree;
              ...
              initialMap[this.posToString(t.x, t.y)] = TEMP_OBJECT_TILES.grass; // ~20%
            }
          }
        });

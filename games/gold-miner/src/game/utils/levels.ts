...
export const pickTemplate = (level: number): LevelTemplate =>
  Utils.Array.GetRandom(LEVEL_TEMPLATES[level]);

export const LEVEL_TEMPLATES: Record<number, LevelTemplate[]> = {
  1: [
    {
      minables: [
        { type: "GOLD_SMALL", nx: 0.2, ny: 0.19 },
        ...
        { type: "GOLD_LARGE", nx: 0.13, ny: 0.5 },
    ...
    },
    {
      minables: [
        ...
        { type: "GOLD_SMALL", nx: 0.76, ny: 0.3 },
  ...
  2: [
    {
      minables: [
        ...
        { type: "GOLD_SMALL", nx: 0.66, ny: 0.4 },
        { type: "GOLD_SMALL", nx: 0.78, ny: 0.4 },
        ...
        { type: "GOLD_LARGE", nx: 0.1, ny: 0.82 },
        { type: "ROCK_SMALL", nx: 0.2, ny: 0.88 },
    ...
    {
      minables: [
        { type: "GOLD_SMALL", nx: 0.07, ny: 0.3 },
        ...
        { type: "ROCK_LARGE", nx: 0.3, ny: 0.58 },
        { type: "GOLD_MEDIUM", nx: 0.7, ny: 0.58 },
        ...
        { type: "GOLD_LARGE", nx: 0.3, ny: 0.86 },
  ...
  3: [
    {
      minables: [
        ...
        { type: "GOLD_SMALL", nx: 0.67, ny: 0.4 },
        { type: "ROCK_LARGE", nx: 0.86, ny: 0.35 },
        { type: "GOLD_SMALL", nx: 0.91, ny: 0.4 },

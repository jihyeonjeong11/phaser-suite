...
function App() {
  ...
  const [activeGamePath, setActiveGamePath] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "arcade" }, activeGamePath ? /* @__PURE__ */ React.createElement("div", { className: "game-view" }, /* @__PURE__ */ React.createElement("div", { className: "game-bar" }, /* @__PURE__ */ React.createElement("button", { className: "back-btn", onClick: exitGame }, "← 목록으로")), /* @__PURE__ */ React.createElement(
    "webview",
    {
      ref: webviewRef,
      src: activeGamePath,
  ...
  )) : /* @__PURE__ */ React.createElement("div", { className: "game-list" }, /* @__PURE__ */ React.createElement("h1", { className: "arcade-title" }, "ARCADE"), /* @__PURE__ */ React.createElement("div", { className: "game-grid" }, games.map((game) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: game.id,
      className: "game-card",
    ...
    /* @__PURE__ */ React.createElement("div", { className: "game-card-title" }, game.title),
    /* @__PURE__ */ React.createElement("p", { className: "game-card-desc" }, game.description),
    /* @__PURE__ */ React.createElement("div", { className: "game-card-tags" }, game.tags.map((tag) => /* @__PURE__ */ React.createElement("span", { key: tag, className: "tag" }, tag)))
  )))));
}
